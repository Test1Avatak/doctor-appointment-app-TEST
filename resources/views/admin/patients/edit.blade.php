...
<x-wire-card class="mb-8">
    <div class="lg:flex lg:justify-between lg:items-center">
        ...
        <x-wire-card>
                ...
                <div class="border-b border-gray-200">
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500">
                      ...
                      'border-transparent hover:text-blue-600 hover:border-gray-300': tab !== 'datos-personales'
                               ...
                               class="inline-flex items-center justify-center p-4 border-b-2 rounded-t-lg transition">
         ...
         'text-blue-600 border-blue-600': tab === 'antecedentes' && !@json($hasError),
         'text-red-600 border-red-600 active': tab === 'antecedentes' && @json($hasError),
         'border-transparent hover:text-blue-600 hover:border-gray-300': tab !== 'antecedentes' && !@json($hasError),
       }"
         ...
         'text-blue-600 border-blue-600': tab === 'informacion-general' && !@json($hasError),
         'text-red-600 border-red-600 active': tab === 'informacion-general' && @json($hasError),
         'border-transparent hover:text-blue-600 hover:border-gray-300': tab !== 'informacion-general' && !@json($hasError),
       }"
                               class="inline-flex items-center justify-center p-4 border-b-2 rounded-t-lg transition-colors duration-200
                               {{ $hasError ? 'text-red-600 border-red-600' : '' }}">
         ...
         'text-blue-600 border-blue-600': tab === 'contacto-emergencia' && !@json($hasError),
         'text-red-600 border-red-600 active': tab === 'contacto-emergencia' && @json($hasError),
         'border-transparent hover:text-blue-600 hover:border-gray-300': tab !== 'contacto-emergencia' && !@json($hasError),
       }"
                               class="inline-flex items-center justify-center p-4 border-b-2 rounded-t-lg transition-colors duration-200
                               {{ $hasError ? 'text-red-600 border-red-600' : '' }}">
                ...
                <div class="px-4 mt-4">
                    ...
                    <div x-show="tab === 'datos-personales'">
                            ...
                            {{-- Lado izquierdo: Información --}}
                                <div class="flex items-start">
                                    <div class="flex-shrink-0">
                                        <i class="fa-solid fa-user-gear text-blue-500 text-xl mt-1">
                                        </i>
                                    </div>
                                    <div class="ml-3">
                        ...
                        <div class="grid kg:grid-cols-2 gap-4">
                            <div>
